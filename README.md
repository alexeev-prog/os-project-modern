# os-project Modern
>Пишем свою собственную операционную систему с нуля! Обновленная версия

Я решил что надо бы создать форк os-project, который не обновлялся 4 года. В этом форке я постараюсь следить современным практикам в создании ОС, обновлю гайд и добавлю больше интересных фишек.

Также в этом гайде я объясню как работать с NixOS.
...
## Установка и запуск
 ...
 > TODO: данный раздел будет переделан, также и кросс-компилятор будет новый.
